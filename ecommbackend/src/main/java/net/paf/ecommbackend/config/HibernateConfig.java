package net.paf.ecommbackend.config;
...
@Configuration
@ComponentScan(basePackages= {"net.paf.ecommbackend.dto"})
...
public class HibernateConfig {
	...
	public DataSource getDataSource() {
		...
		//providing the basic information of the database configuration
	...
	//session factory bean is available
	@Bean
